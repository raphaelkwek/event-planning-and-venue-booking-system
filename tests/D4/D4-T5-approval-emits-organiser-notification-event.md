# D4-T5 — Approving a request emits the event the organiser's notification is built from
...
|---|---|
| Test Case ID | D4-T5 |
| Test Scenario | Approving a request emits the event the organiser's notification is built from |
