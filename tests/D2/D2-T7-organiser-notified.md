...
| Item | Content |
|---|---|
| Actual Result | Blocked: there is no notifications list to open. T2 (Read and manage my notifications) was planned for Sprint 1 but not built — asking for clarification writes an outbox row, and no notification record, read model or screen exists. |
| Status | Blocked |
