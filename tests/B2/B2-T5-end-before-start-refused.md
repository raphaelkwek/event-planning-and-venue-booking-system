...
| Item | Content |
|---|---|
| Actual Result | Refused with "The end date and time must be later than the start date and time." under Proposed end. No submitted row was created. |
| Status | Pass |
| Remarks | Commit: b0ef6ee (working tree modified) · Evidence: tests/B2/evidence/B2-T5.png · Defect: — |
| Executed By | Joash |
